        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
              <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="../WebPages/EmpleadoMejoresClientes.php">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <table id="table-paq" class="mt-4 table table-striped table-sm" >
            ...
            if(isset($_GET['FechaConsultar'])){
                ...
                $GetMejores = "EXECUTE SP_TRES_MEJORES_CLIENTESXPERIODO '$FInicial','$FFinal'";

                $ejecutar = sqlsrv_query($conn,$GetMejores);
          ...
          ?>
            <tbody>
              <tr>
                <td class="text-center align-middle"><?php echo $Cedula ?></td>
                <td class="text-center align-middle" ><?php echo $Nombre ?></td>
                <td class="text-center align-middle"><?php echo $Apellido ?></td>
                <td class="text-center align-middle"><?php echo $Telefono ?></td>
                ...
                ?></td>
                <td class="text-center align-middle"><?php echo $Provincia ?></td>
                <td class="text-center align-middle"><?php echo "₡ $Monto" ?></td>
              </tr>
            </tbody>
